...
namespace CTI {
	...
	//	Function to adjust the translucent lighting fade according to the given shadow attackDistance – or any othe attackDistance that is passed in
	//	@params:
	//	(float) TranslucentLightingRange	: Range in which translucent lighting will be applied – most likely the shadow attackDistance as set in Quality Settings
