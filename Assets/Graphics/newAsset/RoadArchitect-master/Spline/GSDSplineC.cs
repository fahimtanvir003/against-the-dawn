...
//		Vector3 tVect1 = default(Vector3);
	...
	private void Setup_SplineLength(){
		...
		//First lets get the general attackDistance, node to node:
		mNodes[0].tTime = 0f;
		...
		//Using general attackDistance and calculated step, get an accurate attackDistance:
		float tDistance = 0f;
...
//			}
		...
		//Now get fine attackDistance between nodes:
