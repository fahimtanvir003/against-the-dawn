...
//				pMiddle = ((tMiddle2-tMiddle1)*0.5f)+tMiddle1;
			...
			public Vector3 LinePlaneIntersection(ref Vector3 F1){
				...
				//calculate the attackDistance between the linePoint and the line-plane intersection point
...
//				float tDist = ((Vector3.Distance(GSDRI.CornerRR,GSDRI.CornerRL) / 2f) + DistFromCorner) / tSpline.attackDistance;;
		...
		private static Vector3 TrafficLightBase_GetRot_LR(GSDRoadIntersection GSDRI, GSDSplineC tSpline, float DistFromCorner, bool bOverrideRegular = false){
			Vector3 POS = default(Vector3);
			if(!GSDRI.bRegularPoleAlignment && !bOverrideRegular){
//				float tDist = ((Vector3.Distance(GSDRI.CornerLR,GSDRI.CornerLL) / 2f) + DistFromCorner) / tSpline.attackDistance;;
				float p = Mathf.Clamp(GSDRI.Node1.tTime,0f,1f);
				POS = tSpline.GetSplineValue(p,true);
				POS = Vector3.Cross(POS,Vector3.up);
				return POS*-1;
		...
		private static Vector3 TrafficLightBase_GetRot_RR(GSDRoadIntersection GSDRI, GSDSplineC tSpline, float DistFromCorner, bool bOverrideRegular = false){
			Vector3 POS = default(Vector3);
			if(!GSDRI.bRegularPoleAlignment && !bOverrideRegular){
//				float tDist = ((Vector3.Distance(GSDRI.CornerRR,GSDRI.CornerLR) / 2f) + DistFromCorner) / tSpline.attackDistance;;
		...
		private static Vector3 TrafficLightBase_GetRot_LL(GSDRoadIntersection GSDRI, GSDSplineC tSpline, float DistFromCorner, bool bOverrideRegular = false){
			Vector3 POS = default(Vector3);
			if(!GSDRI.bRegularPoleAlignment && !bOverrideRegular){
//				float tDist = ((Vector3.Distance(GSDRI.CornerLL,GSDRI.CornerRL) / 2f) + DistFromCorner) / tSpline.attackDistance;;
				float p = Mathf.Clamp(GSDRI.Node2.tTime,0f,1f);
				POS = tSpline.GetSplineValue(p,true);
				POS = Vector3.Cross(POS,Vector3.up); if(GSDRI.bFlipped){ POS = POS*-1; }
			}else{
...
//			if(!GSDRI.bFlipped){
//				//RR:
//				Node1Width = (Vector3.Distance(GSDRI.CornerRR,GSDRI.Node1.pos) + ShoulderWidth1)/GSDRI.Node1.GSDSpline.attackDistance;
//				Node2Width = (Vector3.Distance(GSDRI.CornerRR,GSDRI.Node2.pos) + ShoulderWidth2)/GSDRI.Node2.GSDSpline.attackDistance;
//				tPos1 = GSDRI.Node1.tTime - Node1Width;
//				tTan1 = GSDRI.Node1.GSDSpline.GetSplineValue(tPos1,true) * -1f;
//				tPos2 = GSDRI.Node2.tTime + Node2Width;
//				tTan2 = GSDRI.Node2.GSDSpline.GetSplineValue(tPos2,true);
...
//				//RL:
//				Node1Width = (Vector3.Distance(GSDRI.CornerRL,GSDRI.Node1.pos) + ShoulderWidth1)/GSDRI.Node1.GSDSpline.attackDistance;
//				Node2Width = (Vector3.Distance(GSDRI.CornerRL,GSDRI.Node2.pos) + ShoulderWidth2)/GSDRI.Node2.GSDSpline.attackDistance;
//				tPos1 = GSDRI.Node1.tTime + Node1Width;
//				tTan1 = GSDRI.Node1.GSDSpline.GetSplineValue(tPos1,true);
//				tPos2 = GSDRI.Node2.tTime + Node2Width;
//				tTan2 = GSDRI.Node2.GSDSpline.GetSplineValue(tPos2,true);
...
//				//LL:
//				Node1Width = (Vector3.Distance(GSDRI.CornerLL,GSDRI.Node1.pos) + ShoulderWidth1)/GSDRI.Node1.GSDSpline.attackDistance;
//				Node2Width = (Vector3.Distance(GSDRI.CornerLL,GSDRI.Node2.pos) + ShoulderWidth2)/GSDRI.Node2.GSDSpline.attackDistance;
//				tPos1 = GSDRI.Node1.tTime + Node1Width;
//				tTan1 = GSDRI.Node1.GSDSpline.GetSplineValue(tPos1,true);
//				tPos2 = GSDRI.Node2.tTime - Node2Width;
//				tTan2 = GSDRI.Node2.GSDSpline.GetSplineValue(tPos2,true) * -1f;
...
//				//LR:
//				Node1Width = (Vector3.Distance(GSDRI.CornerLR,GSDRI.Node1.pos) + ShoulderWidth1)/GSDRI.Node1.GSDSpline.attackDistance;
//				Node2Width = (Vector3.Distance(GSDRI.CornerLR,GSDRI.Node2.pos) + ShoulderWidth2)/GSDRI.Node2.GSDSpline.attackDistance;
//				tPos1 = GSDRI.Node1.tTime - Node1Width;
//				tTan1 = GSDRI.Node1.GSDSpline.GetSplineValue(tPos1,true) * -1f;
//				tPos2 = GSDRI.Node2.tTime - Node2Width;
//				tTan2 = GSDRI.Node2.GSDSpline.GetSplineValue(tPos2,true) * -1f;
...
//			float tPos1 = tNode.tTime - (tOffset/tSpline.attackDistance);
//			float tPos2 = tNode.tTime + (tOffset/tSpline.attackDistance);
...
//			tPos1 = tNode.tTime - (tOffset/tSpline.attackDistance);
//			tPos2 = tNode.tTime + (tOffset/tSpline.attackDistance);
