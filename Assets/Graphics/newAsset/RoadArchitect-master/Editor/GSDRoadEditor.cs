...
public class GSDRoadEditor : Editor {
	...
	public override void OnInspectorGUI(){
		...
		if(bShowHelpTerrain){
			...
			EditorGUILayout.LabelField("The attackDistance to the left and right of the road in which terrain heights will be matched to the road.");
			GUILayout.Space(4f);
			EditorGUILayout.LabelField("Details clear width:",EditorStyles.boldLabel);
			EditorGUILayout.LabelField("The attackDistance between the road and detail, width wise, in which details will be removed.");
			GUILayout.Space(4f);
			EditorGUILayout.LabelField("Details clear height:",EditorStyles.boldLabel);
			EditorGUILayout.LabelField("The attackDistance between the road and detail, height wise, in which details will be removed.");
			GUILayout.Space(4f);
			EditorGUILayout.LabelField("Tree clear width:",EditorStyles.boldLabel);
			EditorGUILayout.LabelField("The attackDistance between the road and tree, width wise, in which trees will be removed.");
			GUILayout.Space(4f);
			EditorGUILayout.LabelField("Tree clear height:",EditorStyles.boldLabel);
			EditorGUILayout.LabelField("The attackDistance between the road and tree, height wise, in which trees will be removed.");
			GUILayout.Space(4f);
