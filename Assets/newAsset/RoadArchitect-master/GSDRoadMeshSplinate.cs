...
//			float jLastTime = 0f;
			float jCurrTime = 0f;
//			float jStep = 0.02f / tSpline.attackDistance;
...
//			float tDistance = 0f;
			...
			if(MVL > 4000000){
				throw new System.Exception("Over 4000000 vertices detected, exiting extrusion. Try switching splination axis and make sure your imported FBX file has proper import scale. Make sure the mesh isn't too small and make sure the attackDistance isn't too large.");
			}
			#else
			if(MVL > 64900){
